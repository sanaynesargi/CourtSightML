...
class APIData:
    ...
    def _get_player_game_logs(self):
        ...
        d = {}
        # Furthest back will be 5 seasons ago 5 seasons ago so 10 total seasons
        for season in get_past_10_seasons(int("20" + self.season[-2:])):
    ...
    def season_avg_ppg(self):
        ...
        time.sleep(0.6)
        player_stats = playerdashboardbygeneralsplits.PlayerDashboardByGeneralSplits(player_id=self.player,
                                                                                     season=self.season,
                                                                                     per_mode_detailed='PerGame').get_data_frames()[
            0]
        return player_stats['PTS'][0]
    ...
    def season_avg_apg_vs_opp(self):
        ...
        time.sleep(0.6)
        player_stats = playerdashboardbyopponent.PlayerDashboardByOpponent(player_id=self.player,
